...
/**
 * Servlet implementation class B_usersIndexServlet
 */
@WebServlet("/users/index")
public class B_usersIndexServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public B_usersIndexServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // データベースから情報を取得
        // ユーザ情報
        List<B_user> users = em.createNamedQuery("getAllUsers", B_user.class)
